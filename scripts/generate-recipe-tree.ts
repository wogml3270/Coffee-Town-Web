...
const families: readonly Family[] = [
  {
    ...
    flows: [
      ...
      { menu: "카페모카", steps: ["에스프레소 컵", "초콜릿 시럽", "모카 베이스", "스팀 밀크", "카페모카"] },
      {
        menu: "카라멜 마키아토",
        steps: ["컵 + 바닐라 시럽", "바닐라 컵", "스팀 밀크", "에스프레소", "카라멜 시럽", "카라멜 마키아토"],
      },
    ],
  },
  {
    ...
    flows: [
      ...
      {
        menu: "카페모카 아이스 블렌디드",
        steps: ["아이스 카페라떼", "초콜릿 시럽", "모카 블렌딩 베이스", "블렌더", "카페모카 아이스 블렌디드"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    flows: [
      ...
      { menu: "초콜릿 라떼", steps: ["컵 + 초콜릿 시럽", "초콜릿 베이스", "스팀 밀크", "초콜릿 라떼"] },
    ],
  },
  {
